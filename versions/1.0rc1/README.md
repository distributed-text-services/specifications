...
<span style="color : red;">The current version is a release candidate. Please provide feedback, typo corrections, etc. on our [issues](https://github.com/distributed-text-services/specifications/issues) before we release a stable version !</span>
...
> Cayless, H., Clérice, T., Jonathan, R., Scott, I., & Almas, B. Distributed Text Services Specifications (Version 1.0rc1) [Computer software]. https://github.com/distributed-text-services/specifications`
...
![Citation tree example diagram](/specifications/assets/img/citation-tree_dracula-example.png)
...
| `dtsVersion` | string | Y | The version of the DTS specification providing the response. Default is "1.0rc1". |
...
Because the `Navigation` object is a top-level object in the API, each object must also have a `@context` property pointing to a DTS JSON-LD context object such as "https://distributed-text-services.github.io/specifications/context/1.0rc1.json".
...
!["pre-order, depth first traversal example"](/specifications/assets/img/tree-traversal_example.png)
