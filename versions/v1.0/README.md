...
- This Version: v1.0
- Previous Version: [1.0rc1](./../1.0rc1/)
...
> Cayless, H., Clérice, T., Jonathan, R., Scott, I., & Almas, B. Distributed Text Services Specifications (Version 1.0) [Computer software]. https://dtsapi.org/versions/v1.0`
...
url = {https://dtsapi.org/versions/v1.0},
version = {v1.0}
}
```
...
| `dtsVersion` | string | Y | The version of the DTS specification providing the response. Default is "1.0". |
...
Because the `Navigation` object is a top-level object in the API, each object must also have a `@context` property pointing to a DTS JSON-LD context object such as "https://dtsapi.org/context/v1.0.json".
